...
import com.app.libs.utilities.*;
import com.app.testbase.VRWebElement;


public class SimpleFormDemoPage extends VRWebElement{
	...
	//================================== Methods =====================================
	// Verify Message
	public boolean verify_message_displayed(String exp_message) {
	...
	public void enterMessage(String message) {
		Uiutils.set_edit_field_value(get_enter_your_message_field(), "Enter your message Field", message);
	}
	
	//click on Show Message
	public void clickShowMessage()  {
		Uiutils.click_element(get_show_message_button(), "Show Message button");
	}
	
	//Enter a 
	public void enterA(String a) {
		Uiutils.set_edit_field_value(get_enter_a_field(), "Enter a", a);
	}
	
	//Enter b 
	public void enterB(String b){
		Uiutils.set_edit_field_value(get_enter_b_field(), "Enter b", b);
	}
	
	//click on Get total
	public void click_get_total_button()  {
		Uiutils.click_element(get_total_button(), "Get Total button");
	}
	
	//Enter A and B
	public void enter_AandB_field_values(String a,String b)  {
	...
	// Verify Total
	public boolean verify_Total_displayed(String exp_total)  {
		boolean result = false;
		String act_total="";
